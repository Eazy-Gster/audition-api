...
public class ExceptionControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    ResponseEntity<String> handleHttpClientException(final HttpClientErrorException e) {
        logger.logStandardProblemDetail(LOG, createProblemDetail(e, e.getStatusCode()), e);
        return new ResponseEntity<>(e.getMessage(), e.getStatusCode());
    }

    @ExceptionHandler(Exception.class)
    ResponseEntity<String> handleMainException(final Exception e) {
        final HttpStatusCode status = getHttpStatusCodeFromException(e);
        logger.logStandardProblemDetail(LOG, createProblemDetail(e, status), e);
        return new ResponseEntity<>(DEFAULT_MESSAGE, status);
    }

    @ExceptionHandler(SystemException.class)
    ResponseEntity<String> handleSystemException(final SystemException e) {
